...
const Header = () => {
  ...
  return (
    <header className="p-4 lg:px-[5%] flex items-center justify-between flex-wrap gap-4">
      ...
      <div className="flex items-center">
        <Image
          ...
          height={50}
        />
        <h1 className="sm:text-xl md:text-2xl lg:text-4xl font-extrabold">GenAI Connect</h1>
      </div>
      {!isIconchanged ? (
        <HamburgerMenuIcon
      ...
      <Button className="px-8 rounded-[20px]">
        Log In
      </Button>
      <Button className="px-6 rounded-[20px]">
        Sign Up
      </Button>
    </div> */}
